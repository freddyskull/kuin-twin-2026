...
export const DashboardHeader: React.FC = () => {
  return (
    <div className="flex items-center justify-between mb-12">
      <div>
        <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">Premium Dashboard</h1>
        <p className="text-slate-400 font-medium">Welcome back, your services are performing well today.</p>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 ml-2">
          <div className="text-right">
            ...
            <p className="text-xs text-slate-500 font-medium">Premium Partner</p>
          </div>
